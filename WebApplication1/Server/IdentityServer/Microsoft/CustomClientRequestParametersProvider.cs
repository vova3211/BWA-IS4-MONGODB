...
namespace WebApplication1.Server.IdentityServer.Microsoft
{
    public class CustomClientRequestParametersProvider : IClientRequestParametersProvider
    {
        public CustomClientRequestParametersProvider(
